                    ...
                    for (let j of ["tshirts", "pants", "hats"]) {
                        for (let k of data[i][j]) {
                            ...
                            if (iprice >= p && iprice <= (p + 10)) {
                                ...
                                // let h6_text = document.createTextNode(k.name);
                                ...
                                // let btn_text = document.createTextNode("View Product")
                                // btn.appendChild(btn_text);
                                // btn.classList.add("btn", "btn-success", "view-prod");

                                // btn.addEventListener("click", () => {

                                //     sessionStorage.setItem("title", data["kids"][category.value][i].name)
                                //     //window.location.href = "./view_prod.html"+data["kids"][category.value][i].price;
                                //     location = "./view_prod.html";
