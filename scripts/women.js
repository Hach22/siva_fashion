                ...
                for (let i in data["women"][category.value]) {
                    ...
                    if (iprice >= p && iprice <= (p + 10)) {
                        ...
                        a.addEventListener("click", () => {
                            ...
                            // localStorage.setItem("title", data["women"][category.value][i].name);
                            // localStorage.setItem("price", data["women"][category.value][i].price);
                            // localStorage.setItem("loc", data["women"][category.value][i].loc);
